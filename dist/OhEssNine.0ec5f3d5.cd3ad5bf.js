...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"projects/ohessnine/dist/OhEssNine.0ec5f3d5.js":[function(require,module,exports) {
var define;
parcelRequire = function (e, r, t, n) {
  ...
  "FXfP": [function (require, module, exports) {
    module.exports = {
      desktop: {
        background: "#8785B6"
      }
  ...
  "xA0X": [function (require, module, exports) {}, {}],
  "J54a": [function (require, module, exports) {
    "use strict";
    ...
    function a(e) {
      ...
      for (var l in e) if (Object.prototype.hasOwnProperty.call(e, l)) {
    ...
    var l = function l(t) {
      ...
      return e.default.createElement("button", {
        className: "close-window-button-container",
        onClick: t.onWindowClose
      }, e.default.createElement("span", {
        className: "close-window-button"
      }));
    },
        i = function i(t) {
      return e.default.createElement(e.Fragment, null, t.isMoving ? e.default.createElement(l, {
        height: t.height,
        x: t.newX,
        y: t.newY,
        width: t.width
      }) : null, e.default.createElement("div", {
        className: "window ".concat(t.isActiveWindow ? "active" : "inactive"),
        onMouseDown: function onMouseDown(e) {
          var n = e.target.className;
          "window" === n || "header" === n ? t.onWindowDragStart(e) : t.onWindowFocus(e);
        },
        style: {
          height: t.height,
          left: t.x,
        ...
        className: "header"
      }, t.isActiveWindow ? e.default.createElement(o, {
        style: {
          justifySelf: "flex-start"
        },
        onWindowClose: t.onWindowClose
      }) : null, e.default.createElement("label", {
        className: "title"
  ...
  "HUEA": [function (require, module, exports) {
    "use strict";
  ...
  "H6N7": [function (require, module, exports) {
    "use strict";
    ...
    var u = function u(t) {
      ...
      }, e.default.createElement("p", null, t.text))), e.default.createElement("div", {
        className: "controls"
      }, u(t.buttons))));
    };
  ...
  "y6SI": [function (require, module, exports) {
    "use strict";
    ...
    function o(t) {
      ...
      for (var u in t) if (Object.prototype.hasOwnProperty.call(t, u)) {
        ...
        c && (c.get || c.set) ? Object.defineProperty(r, u, c) : r[u] = t[u];
      }
    ...
    var v = function (e) {
      ...
      function n(t) {
        var e;
        return c(this, n), (e = r.call(this, t)).state = {}, e;
      }
  ...
  "AAN2": [function (require, module, exports) {
    module.exports = "alert.f24e503c.png";
  }, {}],
  "JoPz": [function (require, module, exports) {
    "use strict";
    ...
    var t = a(require("react")),
        e = a(require("../../preferences")),
        n = s(require("../window")),
        r = s(require("../alert")),
        o = s(require("../icon")),
        i = s(require("../resources/icons/alert.png"));
    ...
    function S(t, e) {
      return !e || "object" !== c(e) && "function" != typeof e ? k(t) : e;
    }
    ...
    var I = function (r) {
      ...
      function s(t) {
        var e;
        return O(this, s), (e = i.call(this, t)).state = {
          icons: [{
            title: "Icon 1",
            x: 1100,
            y: 50
      ...
      return x(s, [{
        ...
        key: "onMouseMove",
        value: function value(t) {
          this.state.activeWindow && this.setState({
            windows: v(v({}, this.state.windows), {}, b({}, this.state.activeWindow, v(v({}, this.state.windows[this.state.activeWindow]), {}, {
              newX: t.screenX - this.state.windows[this.state.activeWindow].xOffset,
              newY: t.pageY - this.state.windows[this.state.activeWindow].yOffset - 32
            })))
          });
        }
      }, {
        key: "handleWindowDragStart",
        value: function value(t, e) {
          this.updateWindowZIndexes(e), this.setState({
            activeWindow: e,
            windows: v(v({}, this.state.windows), {}, b({}, e, v(v({}, this.state.windows[e]), {}, {
              xOffset: t.nativeEvent.offsetX,
              yOffset: t.nativeEvent.offsetY,
              newX: this.state.windows[e].x,
              newY: this.state.windows[e].y
            })))
          });
        }
      }, {
        key: "updateWindowZIndexes",
        value: function value(t) {
          var e = this.state.zIndexes;
          e.splice(this.state.zIndexes.indexOf(t), 1);
          var n = [t].concat(f(e));
          this.setState({
            zIndexes: n.reverse()
          });
        ...
        value: function value(e) {
          ...
          return Object.keys(e).forEach(function (e) {
            var i = r.state.windows[e],
                s = r.state.zIndexes.indexOf(e);
            o.push(t.default.createElement(n.default, {
              key: e,
              x: i.x,
              y: i.y,
              z: r.state.zIndexes.indexOf(e),
              isActiveWindow: s === r.state.zIndexes.length - 1,
              newX: i.newX,
              newY: i.newY,
              height: i.height,
              width: i.width,
              onWindowFocus: function onWindowFocus(t) {
                return r.handleWindowFocus(t, e);
              },
              onWindowClose: function onWindowClose() {
                return r.handleWindowClose(e);
              },
              onWindowDragStart: function onWindowDragStart(t) {
                return r.handleWindowDragStart(t, e);
              },
              isMoving: r.state.activeWindow === e
            }));
          }), o;
        }
      }, {
        ...
        value: function value(t, e) {
          this.updateWindowZIndexes(e);
        }
      }, {
        key: "handleWindowClose",
        value: function value(t) {
          var e = this.state.windows;
          delete e[t], this.setState({
            windows: v({}, e)
          });
        }
      }, {
        ...
        value: function value() {
          ...
          return t.default.createElement("div", {
            ...
            style: {
              backgroundColor: e.desktop.background
            }
          }, this.renderWindows(this.state.windows), this.renderIcons(this.state.icons));
        }
      }]), s;
    }(),
        _ = I;
    ...
    "../alert": "H6N7",
    "../icon": "y6SI",
    "../resources/icons/alert.png": "AAN2",
    "./styles.sass": "xA0X"
  }],
  "i4sQ": [function (require, module, exports) {
    "use strict";
  ...
  "zoI0": [function (require, module, exports) {
    "use strict";
      ...
      return i(o, [{
        ...
        value: function value() {
          var e = this,
              t = new Date(),
              n = t.getHours(),
              r = n > 12 ? n - 12 : 0 === n ? 12 : n,
              o = t.getMinutes(),
              u = t.getMonth() + 1,
              a = n >= 12 ? "PM" : "AM",
              c = t.getDate(),
              i = t.getFullYear(),
              l = "".concat(r, ":").concat(o > 9 ? o : "0".concat(o), " ").concat(a),
              f = "".concat(u, "/").concat(c, "/").concat(i);
          this.setState({
            time: l,
            date: f
          }), setTimeout(function () {
        ...
        value: function value(t) {
          ...
          return t.map(function (t, r) {
            var o;
            return t.items && (o = e.default.createElement("ul", {
              className: "submenu",
              key: r
            }, n.renderMenuItems(t.items))), t.sep ? e.default.createElement("li", {
              className: "menu-separator",
              key: r
            }) : e.default.createElement("li", {
              onClick: t.onClick,
              key: r
            }, t.name, o);
          });
        ...
        value: function value() {
          var n = this;
          return e.default.createElement("menu", {
            className: "menu-bar"
          }, e.default.createElement("ul", {
            className: "align-left"
          }, this.renderMenuItems(t.default)), e.default.createElement("ul", {
            className: "align-right"
          }, e.default.createElement("li", {
            className: "no-hover",
            onClick: function onClick() {
              return n.setState({
                showTime: !n.state.showTime
              });
            }
  ...
  "lMlK": [function (require, module, exports) {
    ...
    !function (n) {
      ...
      if ("function" == typeof e && e.amd && (e(n), t = !0), "object" == typeof exports && (module.exports = n(), t = !0), !t) {
  ...
  "Q8OR": [function (require, module, exports) {
    module.exports = "mikeos.b17ac268.jpg";
  }, {}],
  "I6zw": [function (require, module, exports) {
    "use strict";
    ...
    var e = u(require("react")),
        ...
        r = o(require("js-cookie")),
        n = o(require("../resources/images/mikeos.jpg"));
    ...
    var h = function h(t) {
      ...
      }, "Starting Up..."), e.default.createElement("div", {
      ...
      function a(e) {
        var t;
        return s(this, a), (t = o.call(this, e)).state = {
          loaderProgress: 0
        }, t.loaderSpeed = 50, t;
      }
      ...
      return i(a, [{
        key: "componentDidMount",
        value: function value() {
          r.default.get("hasLoadedBefore") && (this.loaderSpeed = 10), this.initPseudoLoader(), r.default.set("hasLoadedBefore", !0);
        }
      }, {
        key: "handleContextMenu",
        value: function value(e) {
        ...
        key: "initPseudoLoader",
        value: function value() {
          var e,
              t = this;
          e = setInterval(function () {
            return r = 1, t.setState({
              loaderProgress: t.state.loaderProgress + r
            }), void (t.state.loaderProgress >= 100 && clearInterval(e));
            var r;
          }, this.loaderSpeed);
        }
      }, {
        ...
        value: function value() {
          ...
          return e.default.createElement("div", {
            ...
            onContextMenu: function onContextMenu(e) {
              return t.handleContextMenu(e);
            },
            style: {
              display: this.state.loaderProgress >= 100 ? "none" : "flex"
            }
          }, e.default.createElement("div", {
            className: "startup"
          }, e.default.createElement("div", {
    ...
    "prop-types": "Iix9",
    "js-cookie": "lMlK",
    "../resources/images/mikeos.jpg": "Q8OR",
    "./styles.sass": "xA0X"
  }],
  "S89Q": [function (require, module, exports) {
    "use strict";
    ...
    function a(e) {
      ...
      for (var n in e) if (Object.prototype.hasOwnProperty.call(e, n)) {
        var a = u ? Object.getOwnPropertyDescriptor(e, n) : null;
    ...
    var f = function f() {
      return e.default.createElement(e.Fragment, null, e.default.createElement(u.default, null), e.default.createElement(r.default, null), e.default.createElement(t.default, null));
    },
        o = f;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63160" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","projects/ohessnine/dist/OhEssNine.0ec5f3d5.js"], null)
//# sourceMappingURL=/OhEssNine.0ec5f3d5.cd3ad5bf.js.map