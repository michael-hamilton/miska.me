  ...
  <div className="card">
    ...
    <div className="card-footer">
      <div className="card-button-wrapper button-group" role="group" aria-label="Actions">
        {
          props.buttons ?
            props.buttons.map(button => <a className={`button btn-${button.type}`} href={button.url}>{button.title}</a>) : null
        }
      </div>
    </div>
  </div>
    ...
    return (
      <div>
        ...
        <div className="container text-center content-section">
          ...
          <p>I've worked on a number of projects over my career, here are just a few.</p>
